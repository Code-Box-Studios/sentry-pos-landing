...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "cms"."landing_content_detail_bullets" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "cms"."landing_content" (
  	...
  	"hero_sub" varchar DEFAULT 'Sentry is a point-of-sale and monitoring platform for Philippine stores and cafés — ring sales at the counter, then watch sales, profit, and stock across every branch from one dashboard.' NOT NULL,
  ...
  ALTER TABLE "cms"."landing_content_detail_bullets" ADD CONSTRAINT "landing_content_detail_bullets_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "cms"."landing_content"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "cms"."landing_content" ADD CONSTRAINT "landing_content_hero_screenshot_id_media_id_fk" FOREIGN KEY ("hero_screenshot_id") REFERENCES "cms"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "cms"."landing_content" ADD CONSTRAINT "landing_content_detail_screenshot_id_media_id_fk" FOREIGN KEY ("detail_screenshot_id") REFERENCES "cms"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "landing_content_detail_bullets_order_idx" ON "cms"."landing_content_detail_bullets" USING btree ("_order");
  CREATE INDEX "landing_content_detail_bullets_parent_id_idx" ON "cms"."landing_content_detail_bullets" USING btree ("_parent_id");
  ...
  CREATE INDEX "landing_content_hero_hero_screenshot_idx" ON "cms"."landing_content" USING btree ("hero_screenshot_id");
  CREATE INDEX "landing_content_detail_detail_screenshot_idx" ON "cms"."landing_content" USING btree ("detail_screenshot_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "cms"."landing_content_detail_bullets" CASCADE;
